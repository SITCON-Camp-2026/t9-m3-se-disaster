...
export function RecordCard({
  ...
  const [selectedAttachmentId, setSelectedAttachmentId] = useState<
    string | undefined
  >(undefined);
  const [toolSuggestion, setToolSuggestion] = useState<string>(
    record.toolSuggestion ?? "",
  );
    ...
    <article className="record-card">
      ...
      <div className="record-card__actions">
        ...
        <div>
          <button
            ...
            disabled={
              record.arrivedCount !== undefined &&
              judgement?.neededPeople !== undefined &&
            ...
            <div key={a.id} className="record-card__attachment-item">
              {a.mimeType?.startsWith("video") ? (
                <video
                  src={a.url}
                  controls
                  className="record-card__media-preview"
                />
              ) : (
                <audio
                  src={a.url}
              ...
              <div>
                ...
                <button
                  ...
                  className="record-card__attachment-remove"
                >
                  刪除
                </button>
              </div>
            ...
            <div className="record-card__form-field">
              <label>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setSelectedAttachmentId(e.target.value || undefined)
                  }
                >
              ...
              <button
                ...
                onClick={() => {
                  onAddReport?.({
                    ...
                    type: selectedAttachmentId ? "media" : "text",
      ...
      <section className="record-card__section record-card__note-section">
        ...
        <div className="record-card__note-actions">
          ...
          <button type="button" onClick={() => onSaveNote?.(note)}>
            儲存備註
          </button>
        </div>
      </section>
      ...
      <section className="record-card__section record-card__note-section">
        ...
        <div className="record-card__note-actions">
          ...
          <button
            type="button"
            onClick={() => onSaveToolSuggestion?.(toolSuggestion)}
          >
            儲存建議
          </button>
        </div>
